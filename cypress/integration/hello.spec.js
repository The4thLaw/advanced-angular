context('Hello', () => {
    ...
    it('can withdraw from BE1', () => {
        cy.get('#bankAccountIdInput').type('BE1')
        cy.get('#amountToProcessInput').type('50')
    ...
    it('shows an error for invalid withdrawal', () => {
        ...
        cy.get('#bankAccountIdInput').type('BE1')
        cy.get('#amountToProcessInput').type('101')
